...
\newglossaryentry{espacVet}{name={\ensuremath{V_\mathcal{R}}},description={Vector space of  $V$ on $\mathcal{R}$,}}

\newglossaryentry{sconjGer}{name={\ensuremath{\spn{(U)}}},description={Subset spanned by $U$,}}

\newglossaryentry{dimen}{name={\ensuremath{\dim (V_\mathcal{R})}},description={Dimension of $V_\mathcal{R}$,}}
...
\newglossaryentry{grOrto}{name={\ensuremath{O}},description={Orthogonal group,}}

\newglossaryentry{evl}{name={\ensuremath{\evl{\mathcal{R}}{U}{V}}},description={Function space of linear functions that map $U$ to $V$,}}
