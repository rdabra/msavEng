...
A matrix $\mat{A}\in\overline{M}$ is said to be \textsb{positive-semidefinite}\index{matrix!positive-semidefinite} or \textsb{nonnegative}\index{matrix!nonnegative} if
\begin{equation}
