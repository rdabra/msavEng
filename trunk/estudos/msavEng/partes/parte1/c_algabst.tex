...
\end{equation*}
for a generic line and column exchanges. Multiplying the last equality by $\delta_{in}$, we have 
\begin{equation*}
\epsilon_{ijk}\epsilon_{ilm} = \delta_{ii}\delta_{jl}\delta_{km}+\delta_{il}\delta_{jm}\delta_{ki}+\delta_{im}\delta_{ji}\delta_{kl}-\delta_{im}\delta_{jl}\delta_{ki}-\delta_{il}\delta_{ji}\delta_{km}-\delta_{ii}\delta_{jm}\delta_{ki} 
\end{equation*}
