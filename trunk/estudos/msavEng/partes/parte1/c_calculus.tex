...
Recalling the basic concept of class presented on section \ref{sec:Sets}, the double $(M,\css{M})$ is said to be a \textsb{measurable space}\index{space!measurable} when $\sigma$-ring $\css{M}$ is a class of the set $M$ and when this set defines a group, a field or a space we use ``measurable'' to qualify them.
