...
\end{equation} 
can be called the \textsb{residue}\index{function!residue} of $\tnr{\psi}$ at $\tnr{X}_0$. From the fact that $\lim_{\tnr{X}\to \tnr{0}}\fua{r}{\tnr{X}}=\tnr{0}$, if we choose a certain tensor $\tnr{H}\in\pmb{\mathcal{U}}$, it is valid to write that $\lim_{\alpha\to 0}\fua{r}{\alpha\tnr{H}}=\tnr{0}$, where $\alpha\in\cam{F}$. Thereby, considering the argument $\tnr{X}=\alpha\tnr{H}$ on the rule \eqref{eq:residue}, the resulting equality
\begin{equation*}
\fua{[\fua{\tnr{\psi}'}{\tnr{X}_0}]}{\tnr{H}}=\dfrac{\fua{\tnr{\psi}}{\tnr{X}_0+\alpha\tnr{H}}-\fua{\tnr{\psi}}{\tnr{X}_0}-\fua{r}{\alpha\tnr{H}}}{\alpha}
\end{equation*}
can have its both sides taken to the limit of $\alpha$ tending to zero and then the tensor
\begin{equation}
\fua{[\fua{\tnr{\psi}'}{\tnr{X}_0}]}{\tnr{H}}=\lim_{\alpha\to 0}\dfrac{\fua{\tnr{\psi}}{\tnr{X}_0+\alpha\tnr{H}}-\fua{\tnr{\psi}}{\tnr{X}_0}}{\alpha}\,.
\end{equation}
Since $\tnr{H}$ is a specific tensor, we call $\fua{[\fua{\tnr{\psi}'}{\tnr{X}_0}]}{\tnr{H}}\in\ete{\cam{F}}{V^{\times s}}$ the \textsb{directional derivative}\index{derivative!directional} of $\tnr{\psi}$ along $\tnr{H}$ at $\tnr{X}_0$. Moreover, the function in mapping $\map{\tnr{\psi}'_{\tnr{H}}}{\pmb{\mathcal{U}}}{\ete{\cam{F}}{V^{\times s}}}$, whose rule is $\fua{\tnr{\psi}'_{\tnr{H}}}{\tnr{X}}=\fua{[\fua{\tnr{\psi}'}{\tnr{X}}]}{\tnr{H}}$, is called the directional derivative of $\tnr{\psi}$ along $\tnr{H}$.   
