...
\end{equation}
Moreover, a unit normal function is said to be outward, represented by $\vtf{n}^+$, if $\fua{\vtf{n}^+}{\vto{v}}=\pm \fua{\vtf{n}}{\vto{v}}$ such that there exists $\alpha\in\real$ where  
\begin{equation}
\fua{\vtf{n}^+}{\vto{v}}=\pm \fua{\vtf{n}}{\vto{v}}
\begin{cases}
\fua{\vtf{n}}{\vto{v}},& \text{when }\\
-\fua{\vtf{n}}{\vto{v}},& \text{when }\\
\end{cases}
\end{equation}
