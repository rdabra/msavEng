...
Considering $\pmb{\mathcal{U}}$ a Lipschitz domain, we additionally require orientation of the Lipschitz surface $\partial\pmb{\mathcal{U}}$ on each of its boundary points. In order to adequately accomplish this, let    	
