...
\end{equation}
is a symmetric nonnegative operator, usually called \textsb{stretch function}\index{function!stretch}, which represents an affinity symmetric nonnegative tensor\footnote{See corollary \ref{cor:soSymTens} and inequality \eqref{eq:nonnegTensor}.} $\tnr{S}$, called \textsb{stretch tensor}\index{tensor!stretch}. 
