...
\end{align*}
Since last inequality is true for all $\vv{ox},\vv{oy}\in S_\cam{R}$, choosing $\vv{oy}=\vv{ox}$, then $|\vartheta|\geq|\fua{\zeta}{\vv{ox},\vv{ox}}|$ since because $\theta=0$. In this context, from \eqref{eq:projgeo} and \eqref{eq:projColinearEuclid} we obtain $\vartheta=\|\vv{ox}\|$ and $\fua{\zeta}{\vv{ox},\vv{ox}}=\|\vv{ox}\|$ respectively, and then 
$\vartheta=|\fua{\zeta}{\vv{ox},\vv{ox}}|$

 Moreover, since inequality  $|\vartheta|\geq|\fua{\zeta}{\vv{ox},\vv{oy}}|$ is valid for all $\vv{ox},\vv{oy}\in S_\cam{R}$ then, if  $\vv{oy}=\alpha\vv{ox}$, $\alpha\in\{\real\setminus 0\}$, we conclude that $\fua{\zeta}{\vv{ox},\vv{oy}}\geq\vartheta$

only if $\fua{\zeta}{\vv{ox},\vv{oy}}=\vartheta$, otherwise it would fail for $\vv{oy}=\alpha\vv{ox}$, $\alpha\in\{\real\setminus 0\}$, because in this condition if we rewrite \eqref{eq:projgeo} as $\vartheta=\|\vv{ox}\||\cos\theta|\sgn{cos\theta}$, we obtain from \eqref{eq:projColinearEuclid} that $\fua{\zeta}{\vv{ox},\vv{oy}}=\vartheta$ since $\sgn{\alpha}=\sgn{\cos\theta}$ and $|\cos\theta|=1$.
\end{proof}}
