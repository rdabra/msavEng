...
\end{center}
\titfigura{Sum of vectors $\protect\vv{ab}$ and $\protect\vv{xy}$.}\label{fg:vetorSoma}
\end{figure}
...
\end{equation}
norm enables distance measurement. Now, regarding the geometric effects of the inner product, we already said on a previous chapter that this product is closely related to  vector incidence\footnote{See page \pageref{wd:incidence}.}, being a scalar measure of this concept. In the context of affine normed inner product spaces, the incidence interrelationship of non zero vectors $\vv{ov}$ and $\vv{ou}$ is expressed both by the \textsb{projection}\index{projection} $\fua{\zeta}{\vv{ov},\vv{ou}}$ of $\vv{ov}$ onto the line defined by the set $\spn{(\{\vv{ou}\})}$ and projection $\fua{\zeta}{\vv{ou},\vv{ov}}$ of $\vv{ou}$ onto the line defined by $\spn{(\{\vv{ov}\})}$, where $\map{\zeta}{U_\cam{F}^2}{\cam{F}}$ and $\fua{\zeta}{\vv{ox},\vv{oy}}=\vv{ox}\cdot \vv{oy}/\|\vv{oy}\|$. From this rule, if projection is known and not the inner product, we can write that $\vv{ox}\cdot \vv{oy}=\fua{\zeta}{\vv{ox},\vv{oy}}\|\vv{oy}\|$, which is usually and imprecisely regarded as the ``geometric definition'' of the inner product. It is important to note that if arguments $\vv{ox}$ and $\vv{oy}$ are orthogonal, then $\fua{\zeta}{\vv{ox},\vv{oy}}=0$. Moreover, in the context of affine Hilbert spaces, where $\|\vv{ox}\|^2=\vv{ox}\cdot \vv{ox}$, when $\vv{oy}=\alpha\vv{ox}$ then
\begin{equation*}
\fua{\zeta}{\vv{ox},\alpha\vv{ox}}=\dfrac{\overline{\alpha}(\vv{ox}\cdot \vv{ox})}{|\alpha|\|\vv{ox}\|}=\dfrac{\overline{\alpha}\|\vv{ox}\|}{|\alpha|}=\dfrac{|\alpha|}{\alpha}\|\vv{ox}\|\,,\,\forall\alpha\in\{\cam{F}\setminus 0\}.
\end{equation*}
For the specific case of affine Euclidean spaces, these equalities enable us to write that $\fua{\zeta}{\vv{ox},\alpha\vv{ox}}=\pm\|\vv{ox}\|$ for all $\alpha\in\{\real\setminus 0\}$.
