...
In the context of an affine Euclidean space $\eamd{S}{R}{n}$ where $\hat{\vv{ox}},\hat{\vv{oy}}\in S_\cam{R}$ are the normalized vectors of $\vv{ox},\vv{oy}$ respectively, it is valid that $-1\leq\hat{\vv{ox}}\cdot\hat{\vv{oy}}\leq+1$.
\end{mcoro}
