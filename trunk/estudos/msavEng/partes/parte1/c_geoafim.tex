...
\begin{equation}
\fua{\mathit{f}}{\vto{x}\oplus a}=\fua{\tnr{\Upsilon}_{\tnr{A}}}{\vto{x}}\oplus\fua{\mathit{g}}{a}=(\vto{x}\cdot\vto{a}_1)\vto{a}_2\oplus\fua{\mathit{g}}{a}\,,\,\,\forall\,a\in\eamd{U}{F}{m}\,,\,\vto{v}\in U_\cam{F}\,,
\end{equation}
...
Considering previous conditions, an affinity $\mathit{f}$ is said to be centered at point $a$, represented by $\mathit{f}_a$, when $\mathit{g}$ is the identity function, that is, when point $\fua{\mathit{f}_a}{\vto{x}\oplus a}=\fua{\vtf{f}}{\vto{x}}\oplus a$. Moreover, when $\fua{\vtf{f}}{\vto{x}}=\vto{u}$ and $\fua{\mathit{g}}{a}=\vto{x}\oplus a$, we call affinity $\mathit{f}$ a \textsb{translation}\index{translation}, represented by $\mathit{t}_\vto{u}$, described by the rule
