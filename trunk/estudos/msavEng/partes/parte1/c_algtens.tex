...
\tnr{A}\cdot\tnr{B}:=\vto{a}^*_1\otimes\cdots\otimes\vto{a}^*_m\,\,\odot_m\,\,(\vto{b}^c_1)^*\otimes\cdots\otimes(\vto{b}^c_m)^*=\prod_{i=1}^m\vto{b}_i\cdot\vto{a}_i
\end{equation}
...
& = \vto{w}_1\cdot[(\vto{a}_1^*\otimes\vto{a}_2^*)\odot_1(\vto{w}^c_2)^*+(\vto{b}_1^*\otimes\vto{b}_2^*)\odot_1(\vto{w}^c_2)^*]\\
& =\vto{w}_1\cdot\{[(\vto{a}_1^*\otimes\vto{a}_2^*)+(\vto{b}_1^*\otimes\vto{b}_2^*)]\odot_1(\vto{w}^c_2)^*\}\\
& =(\tnr{A}+\tnr{B})\odot_1(\vto{w}^c_2)^*\odot_1(\vto{w}_1^c)^*\\
