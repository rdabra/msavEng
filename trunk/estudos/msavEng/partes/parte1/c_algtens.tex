...
Like any other function, it is possible to consider a tensor function that is the composition of other tensor functions; thereby, inverse tensor functions can also be defined. Considering $\map{\tnr{\psi}}{\ete{\cam{F}}{U^{\times p}}}{\ete{\cam{F}}{V^{\times q}}}$, the existence of an inner product of tensors enables us to state that the function $\tnr{\psi}$     


where the function in $\map{\tnr{\psi}^\dagger}{\ete{\cam{F}}{U^{\times p}}}{\ete{\cam{F}}{V^{\times q}}}$ is the adjoint tensor function of $\tnr{\psi}$.
