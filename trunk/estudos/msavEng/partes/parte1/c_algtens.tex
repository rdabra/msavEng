...
&=\fua{[(\vto{g}_1\cdot\vto{u}^c)\Phi^{-1}\circ\vto{g}_2^*]^*}{\vto{v}}\nonumber\\
&=\overline{\vto{u}^c\cdot\vto{g}_1}\fua{[\Phi^{-1}\circ\vto{g}_2^*]^*}{\vto{v}}\nonumber\\
&=\overline{\fua{\vto{g}_1^*}{\vto{u}^c}}\fua{\vto{g}_2^*}{\vto{v}}\nonumber\\
&=\fua{\vto{g}_1^*}{(\vto{u}^c)^c}\fua{\vto{g}_2^*}{\vto{v}}\nonumber\\
&=\fua{\tnr{G}}{\vto{u},\vto{v}}\,.
\end{align*}
From this equality, if function $\vtf{g}$ is symmetric, then
\begin{equation*}
\fua{\tnr{G}}{\vto{u},\vto{v}}=\fua{\vtf{g}}{\vto{v}}\cdot\vto{u}^c=\overline{\vto{u}^c\cdot\fua{\vtf{g}}{\vto{v}}}=\overline{\fua{\tnr{G}}{\vto{v}^c,\vto{u}^c}}=\fua{\vto{g}_1^*}{(\vto{v}^c)^c}\fua{\vto{g}_2^*}{(\vto{u}^c)^c}=\fua{\tnr{G}}{\vto{v},\vto{u}}.
\end{equation*}
\end{proof}
}
