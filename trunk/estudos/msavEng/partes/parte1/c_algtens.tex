...
{\footnotesize
\begin{proof}
If function $\tnr{\Upsilon}$ were not an injection, there would be two distinct tensors $\tnr{T}$ and $\tnr{W}$ where $\Phi^{-1}\circ\vtf{T}^*_1\circ\Phi(\vto{x})=\Phi^{-1}\circ\vtf{W}^*_1\circ\Phi(\vto{x})$; but this equality leads to $\vtf{T}^*_1(\vto{x}^*)=\vtf{W}^*_1(\vto{x}^*)$, which shows that $\vtf{T}^*_1=\vtf{W}^*_1$. Therefore, since $p$-cotensors are biunivocaly related to tensors, $\tnr{T}$ and $\tnr{W}$ cannot be distinct. Function $\tnr{\Upsilon}$ is also a surjection because, through corollary \ref{cor:covLin}, for every linear function $\vtf{g}\in\evl{\cam{F}}{U}{V}$ a covector function $\vtf{g}_\Phi$ can be defined and then, for every tensor function $\vtf{g}_\Phi$ there exists a unique second order tensor $\tnr{G}\in\ete{\cam{F}}{U\times V}$ where $1$-cotensor $\tnr{G}_1^*=\vtf{g}_\Phi$.
\end{proof}
}

\begin{mcoro}{Symmetric Tensors and Symmetric Operators}{soSymTens}
The set of all symmetric operators of $\evlc{\cam{F}}{U}{U}$ is biunivocaly related to the space of all symmetric second order tensors $\ets{\cam{F}}{U^2}$. 
\end{mcoro}
{\footnotesize
\begin{proof}
Every linear operator $\vtf{g}\in\evl{\cam{F}}{U}{U}$ can be written as a composite function $\Phi^{-1}\circ(\vto{g}_1^*\otimes\vto{g}_2^*)^*_1\circ\Phi$, where $\vto{g}_1^*\otimes\vto{g}_2^*$ is the dyadic description of the arbitrary second order tensor $\tnr{G}\in\ete{\cam{F}}{U^2}$. Thereby, considering arbitrary vectors $\vto{v},\vto{u}\in U_\cam{F}$, the scalar
\begin{align*}
\vto{v}\cdot\fua{\vtf{g}}{\vto{u}^c}&=\fua{[\fua{\vtf{g}}{\vto{u}^c}]^*}{\vto{v}}\nonumber\\
&=\fua{[\fua{\Phi^{-1}\circ(\vto{g}_1^*\otimes\vto{g}_2^*)^*_1\circ\Phi}{\vto{u}^c}]^*}{\vto{v}}\nonumber\\
&=\fua{[\fua{[\Phi^{-1}\circ(\vto{g}_1^*\otimes\vto{g}_2^*)^*_1]}{{\vto{u}^c}^*}]^*}{\vto{v}}\nonumber\\
&=\fua{[(\vto{u}^c\cdot\vto{g}_2)\Phi^{-1}\circ\vto{g}_1^*]^*}{\vto{v}}\nonumber\\
&=(\vto{u}^c\cdot\vto{g}_2)\fua{[\Phi^{-1}\circ\vto{g}_1^*]^*}{\vto{v}}\nonumber\\
&=\fua{\vto{g}_2^*}{\vto{u}^c}\fua{\vto{g}_1^*}{\vto{v}}\nonumber\\
&=\fua{\tnr{G}}{\vto{v},\vto{u}^c}\,.
\end{align*}
From equality \eqref{eq:vecCompConjug}, if function $\vtf{g}$ is symmetric, then
\begin{equation*}
\fua{\tnr{G}}{\vto{v},\vto{u}^c}=\fua{\vtf{g}}{\vto{v}}\cdot\vto{u}^c=\overline{\vto{u}^c\cdot\fua{\vtf{g}}{\vto{v}}}=\overline{\fua{\tnr{G}}{\vto{u}^c,\vto{v}}}
\end{equation*}
\end{proof}
}
...
From the previous corollary, we can state that every linear function $\vtf{g}\in\evl{\cam{F}}{U}{V}$ can be written as a composite function $\Phi^{-1}\circ(\vto{g}_1^*\otimes\vto{g}_2^*)^*_1\circ\Phi$, where $\vto{g}_1^*\otimes\vto{g}_2^*$ is the dyadic description of the arbitrary second order tensor $\tnr{G}\in\ete{\cam{F}}{U\times V}$. Thereby, considering arbitrary vectors $\vto{v}\in V_\cam{F}$ and $\vto{u}\in U_\cam{F}$, the scalar
\begin{align}
\vto{v}\cdot\fua{\vtf{g}}{\vto{u}^c}&=\fua{[\fua{\vtf{g}}{\vto{u}^c}]^*}{\vto{v}}\nonumber\\
&=\fua{[\fua{\Phi^{-1}\circ(\vto{g}_1^*\otimes\vto{g}_2^*)^*_1\circ\Phi}{\vto{u}^c}]^*}{\vto{v}}\nonumber\\
&=\fua{[\fua{[\Phi^{-1}\circ(\vto{g}_1^*\otimes\vto{g}_2^*)^*_1]}{{\vto{u}^c}^*}]^*}{\vto{v}}\nonumber\\
...
\begin{align}
	\fua{\vtf{g}}{\vto{v}}\cdot\vto{u}^c&=\fua{{\vto{u}^c}^*}{\fua{\vtf{g}}{\vto{v}}}\nonumber\\
&=\fua{{\vto{u}^c}^*}{\fua{\Phi^{-1}\circ(\vto{g}_1^*\otimes\vto{g}_2^*)^*_1\circ\Phi}{\vto{v}}}\nonumber\\
&=(\vto{v}\cdot\vto{g}_2)\fua{{\vto{u}^c}^*}{\vto{g}_1}
\end{align}

If function $\vtf{g}$ is symmetric, then 
\begin{align}
	\fua{\tnr{G}}{\vto{v},\vto{u}^c}&=\vto{v}\cdot\fua{\vtf{g}}{\vto{u}^c}\nonumber\\
	&=\fua{[\fua{\Phi^{-1}\circ(\vto{g}_1^*\otimes\vto{g}_2^*)^*_1\circ\Phi}{\vto{u}^c}]^*}{\vto{v}}\nonumber\\
	&=\fua{[\fua{[\Phi^{-1}\circ(\vto{g}_1^*\otimes\vto{g}_2^*)^*_1]}{{\vto{u}^c}^*}]^*}{\vto{v}}\nonumber\\
	&=\fua{[(\vto{u}^c\cdot\vto{g}_2)\Phi^{-1}\circ\vto{g}_1^*]^*}{\vto{v}}\nonumber\\
	&=(\vto{u}^c\cdot\vto{g}_2)\fua{[\Phi^{-1}\circ\vto{g}_1^*]^*}{\vto{v}}\nonumber\\
...
% se a funcao vetorial for simétrica como fica o tensor de segunda? e se a função vetorial for positiva como fica o tensor de segunda ordem?
...
\end{equation}  
We already know the interesting feature that any antisymmetric tensor space is one-di\-men\-sional and thereby the set $\{\tnr{P}\}$ can be a basis of $\etn{\cam{F}}{A^p}$, when it is valid to write that $\tnr{P}^{\tnr{\psi}}=\alpha\tnr{P}$, where $\alpha\in\cam{F}$ is the coordinate of $\tnr{P}^{\tnr{\psi}}$ on $\{\tnr{P}\}$. If a non-zero arbitrary tensor $\tnr{K}\in\etn{\cam{F}}{A^p}$ is considered, let $\beta\in\cam{F}$ be its coordinate on $\{\tnr{P}\}$. As the previous definition \eqref{eq:defDetPsi} is valid for an arbitrary tensor of $\etn{\cam{F}}{A^p}$, the following development
\begin{align*}
...
\end{equation}  
is valid for all $\tnr{P}\in\{\etn{\cam{F}}{A^p}\setminus \tnr{0}\}$ and all $\tnr{X}_i\in\eteg{n}{\cam{F}}{A}$. From this equality, given a basis $B=\{\tnr{B}_1,\cdots,\tnr{B}_p\}$ of tensor space $\eteg{n}{\cam{F}}{A}$, if operator $\tnr{\psi}$ is proper unitary, then   
\begin{equation*}
\fua{\tnr{P}}{\fua{\tnr{\psi}}{\tnr{B}_1},\cdots,{\fua{\tnr{\psi}}{\tnr{B}_p}}}={\fua{\tnr{P}}{\tnr{B}_1,\cdots,\tnr{B}_p}}\,,
\end{equation*}
when we say that basis $\{\fua{\tnr{\psi}}{\tnr{B}_1},\cdots,\fua{\tnr{\psi}}{\tnr{B}_p}\}$, according to theorem \ref{teo:basesUnit}, has the same orientation of $B$. Now, according to theorem \ref{teo:repRieszTensor}, in the particular case where operator $\tnr{\psi}$ is a $m$-cotensor of $\tnr{T}\in \eteg{n}{\cam{F}}{A^2}$, that is, $\tnr{T}_m^*=\tnr{\psi}$, it is possible to state that $\hdet{\tnr{T}}:=\hdet{\tnr{\psi}}$ and then  
\begin{equation}
...
Considering an arbitrary alternating tensor $\tnr{A}\in\etng{n}{\cam{F}}{U^n}$ and an arbitrary unitary tensor operator $\tnr{\psi}\in\grt{U}{\cam{F}}{U^{n}}$, it is valid that $\tnr{A}=\hdet{\tnr{\psi}}\,\fua{\tnr{\psi}}{\tnr{A}}$.
\end{mteo}
{\footnotesize
\begin{proof}
From \eqref{eq:opeTensOrdin}, we know that a unitary tensor operator $\tnr{\psi}\in\grt{U}{\cam{F}}{U^{n}}$ is always related to a unitary operator $\vtf{g}\in\grc{U}{\cam{F}}{U}$. As unitary operators preserve inner product, from \eqref{eq:igAntis}, \eqref{eq:propProdIndTens} and \eqref{eq:detFunDef}, 
\begin{align*}
...
\end{alignat*}
enable us to verify that coordinates $\fua{\tnr{f}_{i}^B}{\tnr{Q}}=\fua{\tnr{f}_{i}^C}{\tnr{Q}}$. Considering these same equalities for the case of a tensor $\tnr{T}$ that has equal coordinates on bases $B$ and $C$, the conclusion of $\fua{\tnr{\psi}}{\tnr{T}}=\tnr{T}$ is straightforward.
\end{proof}
}

Admitting a tensor space $\eteg{m}{\cam{F}}{U^p}$ and a group $\grt{U}{\cam{F}}{U^p}$, where $p$ is even, by equality \eqref{eq:coordIdent} we know that the coordinates of identity tensor $\tnr{I}\in\eteg{m}{\cam{F}}{U^p}$ are the same for any chosen basis. Therefore, from theorem above, it is clear that $\tnr{I}$ is isotropic, that is, $\tnr{I}\in\eto{\cam{F}}{U^p}$. In this context, again by equality \eqref{eq:coordIdent}, it is straightforward to see that the coordinates of an arbitrary tensor belonging to $\spn(\{\tnr{I}\})$ are the same for any chosen basis of $\eteg{m}{\cam{F}}{U^p}$. Therefore, it is possible to affirm that \emph{any linear combination of an identity tensor is isotropic}. Now, from the context of theorem \ref{teo:unimodAltern}, it is straightforward to conclude that an arbitrary alternating tensor $\tnr{A}\in\etng{m}{\cam{F}}{U^m}$ is anti isotropic, that is, equality $\tnr{A}=\fua{\tnr{\psi}}{\tnr{A}}$ is valid only when $\hdet{\tnr{\psi}}=1$. Moreover, we can say that \emph{any linear combination of alternating tensors is anti isotropic}. Finally, it can be obtained that \emph{every permutation of an (anti) isotropic tensor and a linear combination of such permutations are also (anti) isotropic}. It is important to say also that tensor products preserve (anti) isotropy the following way:
\begin{itemize}
\setlength\itemsep{.1em}
...
{\footnotesize
\begin{proof}
First, let's verify the (anti) isotropy of permutation of tensors. Considering equality \eqref{eq:opeTensOrdin}, in the context where unitary operators $\tnr{\psi}^{-1}$ and $\vtf{h}$ are related, for an arbitrary isotropic tensor $\tnr{Q}\in\eto{\cam{F}}{U^{m}}$, the following development proves that $\tnr{Q}_\pi=\fua{\tnr{\psi}}{\tnr{Q}_\pi}$:
\begin{align*}
...
\end{align*}
where $\tnr{\phi}\in\grt{U}{\cam{F}}{U^{m}\times U^{m}}$, proves the first property. The second property is proved by this same development, which is valid only if $\tnr{\psi}\in\tnr{\mathcal{U}}^+_{\cam{F}}({U^{m}})$ since $\tnr{Q}_2$ is anti isotropic. 
\end{proof}
}

At this point, we sacrifice once again self-containednes and humbly stand upon the shoulders of a giant: the german mathematician Hermann Weyl(1885-1955). By proving his Theorem 2.9.A, \aut{Weyl}\cite{weil_1953_2} shows that identity tensor $\tnr{I}\in\eto{\cam{F}}{U^p}$, where $p$ is even, its transpositions and their linear combinations constitute the isotropy group, that is, tensor space
\begin{equation}
\eto{\cam{F}}{U^{p}}= \spn(\{\tnr{I}\})\,\cup\,\spn(\{\tnr{I}_\pi\})\,. 
\end{equation}
For the case of anti isotropic tensors, he arrives at
\begin{equation}
