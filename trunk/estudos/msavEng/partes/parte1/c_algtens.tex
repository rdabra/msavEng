...
\begin{equation}
|\fua{\tnr{A}}{\fua{\vtf{g}}{\vto{u}_1},\cdots,\fua{\vtf{g}}{\vto{u}_m}}|=\fua{\tnr{A}}{\vto{u}_1,\cdots,\vto{u}_m}\,.
\end{equation}
\end{itemize}
