...
\end{equation}
For the sake of generality when manipulating contractive products algebraically, we consider that $\tnr{A}\odot_0\tnr{B}:=\tnr{A}\otimes\tnr{B}$. Moreover, it is straightforward to obtain that these type of products are also associative:
\begin{equation}
