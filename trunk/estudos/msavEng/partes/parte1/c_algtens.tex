...
For the purposes of our study, the contraction that follows is more important than the $r,s$ trace because it generalizes the concept of inner product. In order to define it using the above conditions, let's consider firstly that       
\begin{equation*}
U^{\times m}=\underbrace{U_1\times\cdots\times U_{q}\times W_1\times\cdots\times W_{p}}_{A^{\times q+p}}\times \underbrace{W_1\times\cdots\times W_{p}\times Z_{1}\times\cdots\times Z_{n}}_{B^{\times p+n}}\,,
\end{equation*}
where $m=p+2p+n$, and secondly that    
\begin{equation*}
\fua{{\vtf{c}}_2}{\tnr{A}\otimes\tnr{B}}:=\overline{\fua{\tnr{I}}{\vto{x}_{r},\vto{x}_{s}}}\,\vto{x}_1^*\otimes\cdots\otimes\vto{x}_{r-1}^*\otimes\vto{x}_{r+1}^*\otimes\cdots\otimes\vto{x}_{s-1}^*\otimes\vto{x}_{s+1}^*\otimes\cdots\otimes\vto{x}_m^*\,,
\end{equation*} 

\begin{align}
\lefteqn{\fua{{\vtf{c}}_2}{\vto{x}_1,\cdots,\vto{x}_m}:=} & & \nonumber\\
	& &\overline{\fua{\tnr{I}}{\vto{x}_{r},\vto{x}_{s}}}\,\vto{x}_1^*\otimes\cdots\otimes\vto{x}_{r-1}^*\otimes\vto{x}_{r+1}^*\otimes\cdots\otimes\vto{x}_{s-1}^*\otimes\vto{x}_{s+1}^*\otimes\cdots\otimes\vto{x}_m^*\,,
\end{align}
