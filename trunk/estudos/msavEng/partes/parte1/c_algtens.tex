...
If a tensor space can be structured as any other ordinary vector space, it is possible to consider a function space $V^U_\cam{F}$ where  domain $U={\ete{\cam{F}}{U^{\times m}}}$ and codomain $V=\ete{\cam{F}}{V^{\times n}}$ are complete vector spaces, with a properly defined metric. 
