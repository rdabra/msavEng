...
An open set is called \textsb{clopen}\index{set!clopen} when its complement is also open. As an example, the sets $W_1=[1,2]$ e $W_2=[3,4]$, defined by intervals of real values,   
