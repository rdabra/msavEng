...
\newglossaryentry{setCollect}{name={\ensuremath{\{a,b,b,a,c\}_{\neq}}},description={Set of the distinct elements of \{a,b,b,a,c\},}}
...
\newglossaryentry{pCotensor}{name={\ensuremath{\frt{T}_p}},description={$p$-cotensor of $\tnr{T}$,}}

\newglossaryentry{cotensor}{name={\ensuremath{\frt{T}}},description={Cotensor of $\tnr{T}$,}}

\newglossaryentry{substFunc}{name={\ensuremath{\overline{\frt{T}}}},description={Representative function of $\tnr{T}$,}}
...
\newglossaryentry{bdy}{name={\ensuremath{\mathsf{B}}},description={Body,}}
...
\newglossaryentry{confi}{name={\ensuremath{ \chi }},description={Motion of a body,}}
...
\newglossaryentry{lagTimeDeriv}{name={\ensuremath{  {\bar{\partial}}_t\bullet }},description={Lagrangian time derivative of...,}}

\newglossaryentry{eulerTimeDeriv}{name={\ensuremath{  {\tilde{\partial}}_t\bullet }},description={Eulerian time derivative of...,}}
