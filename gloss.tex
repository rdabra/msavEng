...
\newglossaryentry{espacoTens}{name={\ensuremath{\ete{\mathcal{R}}{U^{\times m}}}},description={Tensor space of order $m$ defined by $(U_i^*)_\mathcal{R}$,}}

\newglossaryentry{tensor}{name={\ensuremath{\tnr{T}}},description={Tensor,}}

\newglossaryentry{espacoTensTipo}{name={\ensuremath{\ete{\mathcal{R}}{V^{(p,q)}}}},description={Type $(p,q)$ tensor space,}}
