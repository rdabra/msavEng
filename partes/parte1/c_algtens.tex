...
In the previous section, equalities \eqref{eq:prodContrCoord} and \eqref{eq:prodIntCoord}, which are respectively the  contractive and inner product of tensors expressed in terms of coordinates, can be rewritten as follows:
\begin{alignat}{3}
\tnr{A}\diamond\tnr{B} = \mav{\tnr{A}}{B}{\mav{\tnr{B}}{B}}^\text{T}&\qquad\text{ and }\qquad&\tnr{A}\cdot\tnr{B} = \mav{\tnr{A}}{B}{\mav{\tnr{B}}{B}}^\dagger
\end{alignat}
