...
\noindent Still considering an arbitrary second order tensor $\tnr{G}\in\ete{\cam{F}}{U\times V}$ and its representative function $\tnr{\mathit{g}}$, we now sacrifice mathematical rigor in favor of mathematical practicality by specifying two tensors in $\ete{\cam{F}}{V\times U}$:   
\begin{itemize}
\setlength\itemsep{.1em}
