...
\item[iii.] definir potencia de tensor
\end{itemize}
...
\end{equation}
\item[iii.] If functions $\tnr{\mathit{g}}_1$ and $\tnr{\mathit{g}}_2$ represent $\tnr{G}_1\in\ete{\cam{F}}{U\times W}$ and $\tnr{G}_2\in\ete{\cam{F}}{W\times V}$, then 
