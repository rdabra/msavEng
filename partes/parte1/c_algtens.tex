...
\fua{\tnr{G}}{\vto{u},\vto{v}} = \fua{\vto{g}_1^*}{\vto{u}}\fua{\vto{g}_2^*}{\vto{v}} = \vto{v}\cdot\overline{\fua{\vto{g}_1^*}{\vto{u}}}\vto{g}_2 = \vto{v}\cdot\fua{\vto{g}_1^*}{\vto{u}^c}\vto{g}_2= \vto{v}\cdot\fua{\tnr{\mathit{g}}}{\vto{u}^c}\,.
\end{equation}
From these equalities we can write that $\fua{\tnr{G}}{\vto{u}^c,\vto{v}}=\vto{v}\cdot\fua{\tnr{\mathit{g}}}{\vto{u}}$. From definitions of Hilbert-adjoint and transpose functions described by \eqref{eq:HilbAdj}, it is interesting to note that if a representative operator $\tnr{\mathit{t}}\in\evl{\cam{F}}{U}{U}$ is Hermitian then
\begin{equation*}
