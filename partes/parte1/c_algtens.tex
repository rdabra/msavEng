...
\end{align*}  
leads to equality $\tnr{K}^{\tnr{\psi}}=\alpha\tnr{K}$. Therefore, it is possible to conclude that the coordinate of any tensor $\tnr{K}^{\tnr{\psi}}$ is always $\alpha$, which is then related only to function $\tnr{\psi}$. Because of this exclusivity, scalar $\alpha$ is defined to be the \textsb{determinant of operator}\index{tensor operator!determinant of} $\tnr{\psi}$ and, from definition \eqref{eq:defDetPsi}, the function in $\map{\text{Det}}{\evl{\cam{F}}{\ete{\cam{F}}{A}}{\ete{\cam{F}}{A}}}{\cam{F}}$ has the rule
\begin{equation}
\hdet{\tnr{\psi}}=\dfrac{\fua{\tnr{P}}{\fua{\tnr{\psi}}{\tnr{X}_1},\cdots,{\fua{\tnr{\psi}}{\tnr{X}_p}}}}{\fua{\tnr{P}}{\tnr{X}_1,\cdots,\tnr{X}_p}}\,,
\end{equation}  
for all $\tnr{P}\in\{\etn{\cam{F}}{A^p}\setminus \tnr{0}\}$ and $\tnr{X}_i\in\ete{\cam{F}}{A}$. According to theorem \ref{teo:repRieszTensor}, in the particular case where operator $\tnr{\psi}$ is a $m$-cotensor of $\tnr{T}\in \ete{\cam{F}}{A^2}$, that is, $\tnr{T}_m^*=\tnr{\psi}$, it is possible to state that $\hdet{\tnr{T}}:=\hdet{\tnr{\psi}}$ and then 
\begin{equation}
\hdet{\tnr{T}}=\dfrac{\fua{\tnr{P}}{\fua{\tnr{T}_m^*}{\tnr{X}_1},{\fua{\tnr{T}_m^*}{\tnr{X}_2}}}}{\fua{\tnr{P}}{\tnr{X}_1,\tnr{X}_2}}\,.
\end{equation}  
