...
\end{equation}
\item[iii.] If functions $\tnr{\mathit{g}}_1$ and $\tnr{\mathit{g}}_2$ represent $\tnr{G}_1\in\ete{\cam{F}}{U\times W}$ and $\tnr{G}_2\in\ete{\cam{F}}{W\times V}$, 
...
\end{equation}
and then, for $\tnr{G}\in\ete{\cam{F}}{U^2}$,
...
\end{equation}
where tensor $\tnr{P}\in\etng{p}{\cam{F}}{U^{p}}$ and $\tnr{\mathit{t}}$ is the representative function of $\tnr{T}$. Now, considering arbitrary functions $\tnr{\psi},\tnr{\varphi}\in\evl{\cam{F}}{\eteg{n}{\cam{F}}{U^{\times m}}}{\eteg{n}{\cam{F}}{U^{\times m}}}$, the following properties of determinant of tensor operators are valid:
\begin{itemize}
\setlength\itemsep{.1em}
\item[i.] $\hdet{\tnr{i}} =  1$;
