...
\fua{\tnr{\mathit{g}}}{\vto{u}} = \fua{\Phi^{-1}\circ\tnr{G}^*_1\circ\Phi}{\vto{u}} = \fua{\Phi^{-1}}{\vto{u}^*\odot_1\tnr{G}} =\vto{u}^*\hat{\odot}_1\tnr{G}=(\vto{u}\cdot\vto{g}_1)\vto{g}_2
\end{equation}
...
\noindent Still considering an arbitrary second order tensor $\tnr{G}\in\ete{\cam{F}}{U\times V}$ and its representative function $\tnr{\mathit{g}}$, we now sacrifice mathematical rigor in favor of mathematical practicality by specifying three tensors in $\ete{\cam{F}}{V\times U}$:   
\begin{itemize}
\setlength\itemsep{.1em}
...
[\vto{u}^*\hat{\odot}_1(\vto{a}^*\otimes\vto{b}^*)^\dagger]\cdot\vto{v}&=\vto{u}\cdot[\vto{v}^*\hat{\odot}_1(\vto{a}^*\otimes\vto{b}^*)]\\
...
\vto{v}^*\hat{\odot}_1\tnr{I}&=\tnr{\mathit{g}}[\vto{v}^*\hat{\odot}_1\tnr{G}^{-1}]\\
&=[\vto{v}^*\odot_1\tnr{G}^{-1}]\hat{\odot}_1\tnr{G}\\
&=\vto{v}^*\hat{\odot}_1(\tnr{G}^{-1}\odot_1\tnr{G})
\end{align*}
proves the first identity tensor of the second item. Verification of $\tnr{G}\odot_1\tnr{G}^{-1}$ is similar.
\end{proof}
}
