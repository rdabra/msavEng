...
Now that we know the determinant of linear tensor operators and its properties, let $\tnr{\varphi}$ be an arbitrary element of a group $\grt{G}{\cam{F}}{V^{\times m}}$ of invertible continuous linear tensor operators whose domain is Hilbert tensor space $\ete{\cam{F}}{V^{\times m}}$. A tensor $\tnr{T}\in\ete{\cam{F}}{V^{\times m}}$ is said to be \textsb{invariant}\index{tensor!invariant} on group $\grt{G}{\cam{F}}{V^{\times m}}$ if $\fua{\tnr{\varphi}}{\tnr{T}}=\tnr{T}$. When this equality is valid for arbitrary $\tnr{T}$, the whole tensor space $\ete{\cam{F}}{V^{\times m}}$ is considered invariant on $\grt{G}{\cam{F}}{V^{\times m}}$. Moreover, if group $\grt{G}{\cam{F}}{V^{\times m}}$ is orthogonal, that is, $\grt{G}{\cam{F}}{V^{\times m}}=\grt{O}{\cam{F}}{V^{\times m}}$, tensor $\tnr{T}$ is said to be \textsb{isotropic}\index{tensor!isotropic} on this group. In the case of arbitrary $\tnr{T}$, space $\ete{\cam{F}}{V^{\times m}}$ is called isotropic on $\grt{O}{\cam{F}}{V^{\times m}}$.
