...
\end{equation}
where $p=n^2$. Now, considering arbitrary functions $\tnr{\psi},\tnr{\varphi}\in\evl{\cam{F}}{\eteg{n}{\cam{F}}{U^{\times m}}}{\eteg{n}{\cam{F}}{U^{\times m}}}$, the following properties of determinant of tensor operators are valid:
\begin{itemize}
\setlength\itemsep{.1em}
\item[i.] $\hdet{\tnr{i}} =  1$;
