...
At this point, we sacrifice once again self-containednes and humbly stand upon the shoulders of a giant. By proving his Theorem 2.9.A, \aut{Weyl}\cite{weil_1953_2}\footnote{See also \aut{Backus}\cite{backus_1997_1}, p. 80.} shows that identity tensor $\tnr{I}\in\eto{\cam{F}}{A^p}$, where $A=U^{m}$ and $p$ is even, its transpositions and their linear combinations constitute the isotropy group, that is,
\begin{equation}
