...
\begin{multline*}
\fua{\tnr{P}}{\fua{\tnr{\psi}}{\vtf{f}_{i_1^{(1)}}^{B_1}\otimes\cdots\otimes\vtf{f}_{i_m^{(1)}}^{B_m}},\fua{\tnr{\psi}}{\vtf{f}_{i_1^{(2)}}^{B_1}\otimes\cdots\otimes\vtf{f}_{i_m^{(2)}}^{B_m}}} = \sum_{i_1^{(1)}=1}^{n_1}\cdots\sum_{i_p^{(1)}=1}^{n_p}\sum_{j_1^{(1)}=1}^{n_1}\cdots\sum_{j_m^{(1)}=1}^{n_m}\sum_{i_1^{(2)}=1}^{n_1}\cdots\sum_{i_p^{(2)}=1}^{n_p}\\\sum_{j_1^{(2)}=1}^{n_1}\cdots\sum_{j_m^{(2)}=1}^{n_m}{\maf{\tnr{\psi}}{B}{C}}_{i_1^{(1)}\cdots i_p^{(1)} j_1^{(1)}\cdots j_m^{(1)}}\vtf{f}_{j_1^{(1)}\cdots j_m^{(1)}}^{B}(\tnr{X})\,\fua{\tnr{P}}{\vtf{f}_{j_1^{(1)}}^{C_1}\otimes\cdots\otimes\vtf{f}_{j_p^{(1)}}^{C_p},\vtf{f}_{j_1^{(2)}}^{C_1}\otimes\cdots\otimes\vtf{f}_{j_p^{(2)}}^{C_p}}
\end{multline*}
\end{proof}
}
