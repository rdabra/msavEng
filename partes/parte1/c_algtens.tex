...
Admitting a tensor space $\eteg{n}{\cam{F}}{U^{\times m}\times U^{\times m}}$ and a group $\grt{U}{\cam{F}}{U^{\times m}\times U^{\times m}}$, by equality \eqref{eq:coordIdent} we know that the coordinates of identity tensor $\tnr{I}\in\eteg{n}{\cam{F}}{U^{\times m}\times U^{\times m}}$ are the same for any chosen basis. Therefore, from theorem above, it is clear that $\tnr{I}$ is isotropic, that is, $\tnr{I}\in\eto{\cam{F}}{U^{\times m}\times U^{\times m}}$.
