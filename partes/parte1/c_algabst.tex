...
\end{equation*}
for a generic line and column exchanges. Then we have 
\begin{align*}
\epsilon_{ijk}\epsilon_{nlm} & =  \delta_{in}\delta_{jl}\delta_{km}+\delta_{il}\delta_{jm}\delta_{kn}+\delta_{im}\delta_{jn}\delta_{kl}-\delta_{im}\delta_{jl}\delta_{kn}-\delta_{in}\delta_{jm}\delta_{kl}-\delta_{il}\delta_{jn}\delta_{km}\\
& =  \delta_{in}(\delta_{jl}\delta_{km}+\delta_{jm}\delta_{kl}+\delta_{jm}\delta_{kl}-\delta_{jl}\delta_{km}-\delta_{jl}\delta_{km}-\delta_{jm}\delta_{kl}) \\
