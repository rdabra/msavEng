...
\end{equation*}
for a generic line and column exchanges. Multiplying both sides by $\delta_{in}$, we have 
\begin{align*}
\epsilon_{ijk}\epsilon_{ilm} & =  \delta_{ii}\delta_{jl}\delta_{km}+\delta_{il}\delta_{jm}\delta_{ki}+\delta_{im}\delta_{ji}\delta_{kl}-\delta_{im}\delta_{jl}\delta_{ki}-\delta_{ii}\delta_{jm}\delta_{kl}-\delta_{il}\delta_{ji}\delta_{km}\\
& =  \delta_{ii}\delta_{jl}\delta_{km}+\delta_{jm}\delta_{kl}+\delta_{jm}\delta_{kl}-\delta_{jl}\delta_{km}-\delta_{ii}\delta_{jm}\delta_{kl}-\delta_{jl}\delta_{km}\\
& =  \delta_{jl}\delta_{km}(\delta_{ii}-2) + \delta_{jm}\delta_{kl}(2-\delta_{ii})\\
& =  (2-\delta_{ii})(\delta_{jm}\delta_{kl}-\delta_{jl}\delta_{km})
\end{align*}
Summing both sides on $i$, we arrive at 
\begin{equation*}
\sum_{i=1}^3\epsilon_{ijk}\epsilon_{ilm}=3(\delta_{jl}\delta_{km}-\delta_{jl}\delta_{km})
\end{equation*}
\end{proof}}
