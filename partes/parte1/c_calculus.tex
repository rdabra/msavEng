...
\end{equation*}
and, by the same development, $\int_E f^-=0$, which prove item ii. From property i and trivial properties of multiplication by scalar, proof of item iii is straightforward.  
\end{proof}}
