...
\end{equation}
is the representative function of $\tnr{G}_{\vto{x}_0^*}$. Moreover, it is convenient to have a vector function  
...
\end{equation}
where $\mathcal{U}$ is constituted by the corresponding vectors to the elements of $\pmb{\mathcal{U}}$. Considering rule \eqref{eq:directDeriv}, from the definitions \eqref{eq:repFuncGrad2} and \eqref{eq:primiRepFuncGrad2}, it is possible to develop the following for an arbitrary direction $\vto{h}^*\in\pmb{\mathcal{U}}$:  
...
\end{align}
which results the rule of the directional derivative of the vector function in $\map{\tnr{\mathit{g}}}{\mathcal{U}}{U_\real}$ along $\vto{h}\in\mathcal{U}$. From this result, \emph{the derivative $\tnr{\mathit{g}}'_{\vto{x}^*}$, as a linear vector function, inherits all the previous and forthcoming definitions of a linear tensor function $\fua{\tnr{\psi}'}{\tnr{X}}$}. For example, by \eqref{eq:derivSameArg} and \eqref{eq:defGradient2}, we can write that
\begin{equation}\label{eq:derivSameArg2}
\fua{D\tnr{\mathit{g}}}{\vto{x}} := \fua{\tnr{\mathit{g}}'_{\vto{x}^*}}{\vto{x}}\,.
\end{equation}
Still in the context of vector functions, when $U_{\cam{R}}=\cam{R}$, from mapping $\map{\mathit{g}}{\mathcal{U}}{{\cam{R}}}$ and the previous equality, we write that
\begin{equation*}
...
\begin{itemize}
	...
	\end{equation}
	\item[iv.] If $\fua{\tnr{\mathit{g}}}{\vto{x}}=\fua{\tnr{\mathit{g}}_1}{\vto{x}}\times\fua{\tnr{\mathit{g}}_2}{\vto{x}}$, where $U_\real$ in mappings  $\map{\tnr{\mathit{g}}_1}{{\mathcal{U}}}{U_\cam{R}}$ and $\map{\tnr{\mathit{g}}_2}{{\mathcal{U}}}{U_\cam{R}}$ is properly defined for enabling cross products, 
\begin{equation}\label{eq:crossRule}
\fua{[\fua{\tnr{\mathit{g}}'}{\vto{x}}]}{\vto{h}} = \fua{\tnr{\mathit{g}}_1}{\vto{x}}\times\fua{[\fua{\tnr{\mathit{g}}_2'}{\vto{x}}]}{\vto{h}} + \fua{[\fua{\tnr{\mathit{g}}_1'}{\vto{x}}]}{\vto{h}} \times \fua{\tnr{\mathit{g}}_2}{\vto{x}}\,,\,\forall \vto{h}\in\mathcal{U}\,,
\end{equation}
and then 
	\begin{equation}\label{eq:prop3Grad}
	\fua{\nabla\tnr{\mathit{g}}}{\vto{x}} = \fua{\nabla\tnr{\mathit{g}}_1}{\vto{x}}\times\fua{\tnr{\mathit{g}}_2}{\vto{x}}-\fua{\nabla\tnr{\mathit{g}}_2}{\vto{x}}\times\fua{\tnr{\mathit{g}}_1}{\vto{x}}\,.
	\end{equation}
...
&=\tnr{H}\odot_m\{\fua{[\nabla\tnr{\psi}_1]}{\tnr{X}}\odot_s\fua{\tnr{\psi}_2}{\tnr{X}}+\fua{[\nabla\tnr{\psi}_2]}{\tnr{X}}\odot_s\fua{\tnr{\psi}_1}{\tnr{X}}\}\,,
\end{align*}
which proves item iii. Considering $(U_\real,\tnr{A}_B)$ a three dimensional oriented Euclidean space, we prove the equalities of item iv first by the development
\begin{align*}
\fua{[\fua{\tnr{\mathit{g}}'}{\vto{x}}]}{\vto{h}}&=\lim_{\alpha\to 0}1/\alpha\{\tnr{A}_B\odot_{2}[\fua{\tnr{\mathit{g}}_1}{\vto{x}+\alpha\vto{h}}\otimes\fua{\tnr{\mathit{g}}_2}{\vto{x}+\alpha\vto{h}}]-\tnr{A}_B\odot_{2}[\fua{\tnr{\mathit{g}}_1}{\vto{x}}\otimes\fua{\tnr{\mathit{g}}_2}{\vto{x}}]\}\\
&=\tnr{A}_B\odot_{2}\lim_{\alpha\to 0}1/\alpha\{\fua{\tnr{\mathit{g}}_1}{\vto{x}+\alpha\vto{h}}\otimes\fua{\tnr{\mathit{g}}_2}{\vto{x}+\alpha\vto{h}}-\fua{\tnr{\mathit{g}}_1}{\vto{x}}\otimes\fua{\tnr{\mathit{g}}_2}{\vto{x}}\}
\end{align*}
and then by adding and subtracting the limit on the right hand side by $\fua{\tnr{\mathit{g}}_1}{\vto{x}+\alpha\vto{h}}\otimes\fua{\tnr{\mathit{g}}_2}{\vto{x}}$ we obtain
\begin{equation*}
\fua{[\fua{\tnr{\mathit{g}}'}{\vto{x}}]}{\vto{h}}= \tnr{A}_B\odot_{2}[\fua{\tnr{\mathit{g}}_1}{\vto{x}}\otimes\fua{[\fua{\tnr{\mathit{g}}_2'}{\vto{x}}]}{\vto{h}}]+\tnr{A}_B\odot_{2}[ \fua{[\fua{\tnr{\mathit{g}}_1'}{\vto{x}}]}{\vto{h}} \otimes \fua{\tnr{\mathit{g}}_2}{\vto{x}}]\,,
\end{equation*}
from which we easily verify the first equality of iv. From this same equality, development
\begin{align*}
\fua{[\fua{\tnr{\mathit{g}}'}{\vto{x}}]}{\vto{h}} &= \fua{[\fua{\tnr{\mathit{g}}_1'}{\vto{x}}]}{\vto{h}} \times \fua{\tnr{\mathit{g}}_2}{\vto{x}}-\fua{[\fua{\tnr{\mathit{g}}_2'}{\vto{x}}]}{\vto{h}}\times\fua{\tnr{\mathit{g}}_1}{\vto{x}}\\
\vto{h}\odot_{1}\fua{\nabla\tnr{\mathit{g}}}{\vto{x}}&=\vto{h}\odot_{1}[\fua{\nabla\tnr{\mathit{g}}_1}{\vto{x}}\times\fua{\tnr{\mathit{g}}_2}{\vto{x}}-\fua{\nabla\tnr{\mathit{g}}_2}{\vto{x}}\times\fua{\tnr{\mathit{g}}_1}{\vto{x}}]
\end{align*}
