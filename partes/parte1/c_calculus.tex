...
Now, for the case of a measure space $(\eamd{S}{\real}{n},\css{M},\mu)$, where affine space $M=\eamd{S}{\real}{n}$ is Euclidean, let the points $a_i$ and $b_i$ be arbitrary elements of $M$. Considering distances $L_i:=\fua{\varrho}{a_i,b_i}$, let $vol(C)=\prod_{i=1}^n L_i$ be the hypervolume of an arbitrary hyperrectangle $C$. If $C_1,C_2,\cdots$ is an arbitrary sequence of hyperrectangles that covers $M$, then  




given $A\in\css{M}$, the value $\lambda(A)$ is called the Labesgue Measure of $A$, which corresponds to distance, area and volume of $A$ according to whether $M$ is one, two or three dimension respectively.  
...
\begin{equation*}
\int_{\hat{\pmb{\mathcal{U}}}}\dvt{\vtf{\varphi}}\;d\mu = \int_{\partial{\pmb{\mathcal{U}}}}\vtf{\varphi}_\odot\;d\mu\,\,.
\end{equation*}
\end{mteo}
\hspace{1pt}
{\footnotesize
...
\begin{equation*}
	\int_{\hat{\pmb{\mathcal{U}}}}\nabla{\vtf{\varphi}}\;d\mu = \int_{\partial{\pmb{\mathcal{U}}}}\vtf{\varphi}_\otimes\;d\mu\,\,.
\end{equation*}
\end{mcoro}
{\footnotesize
\begin{proof}
...
\begin{align*}
\tnr{I}\odot_2	\int_{\hat{\pmb{\mathcal{U}}}}\nabla{\vtf{\varphi}}\;d\mu & = \tnr{I}\odot_2 \int_{\partial{\pmb{\mathcal{U}}}}\vtf{\varphi}_\otimes\;d\mu\\
\int_{\hat{\pmb{\mathcal{U}}}} \frt{I}\circ\nabla{\vtf{\varphi}}\;d\mu& =\int_{\partial{\pmb{\mathcal{U}}}}\frt{I}\circ\vtf{\varphi}_\otimes\;d\mu\,.
\end{align*}
...
\begin{equation*}
\int_{\hat{\pmb{\mathcal{U}}}}\crl{\vtf{\varphi}}\;d\mu = \int_{\partial{\pmb{\mathcal{U}}}}\vtf{\varphi}_\times\;d\mu\,\,.
\end{equation*}
\end{mcoro}
{\footnotesize
\begin{proof}
...
\begin{align*}
\int_{\hat{\pmb{\mathcal{U}}}}\crl{\vtf{\varphi}}\;d\mu & = \int_{\partial{\pmb{\mathcal{U}}}}\vtf{\varphi}_\times\;d\mu\\
\int_{\hat{\pmb{\mathcal{U}}}}\tnr{A}_B\odot_2\nabla{\vtf{\varphi}}\;d\mu & = \int_{\partial{\pmb{\mathcal{U}}}}\frt{A}_B\circ\vtf{\varphi}_\otimes\;d\mu\\
\tnr{A}_B\odot_2\int_{\hat{\pmb{\mathcal{U}}}}\nabla{\vtf{\varphi}}\;d\mu & = \tnr{A}_B\odot_2\int_{\partial{\pmb{\mathcal{U}}}}\vtf{\varphi}_\otimes\;d\mu\,.
\end{align*}
\end{proof}
}
...
\begin{equation*}
\int_{\widehat{{\pmb{\mathcal{S}}}}}\vtf{\varphi}_{\widehat{\pmb{\mathcal{S}}}}\;d\mu = \int_{\partial{\pmb{\mathcal{S}}}}\vtf{\varphi}_{\partial\pmb{\mathcal{S}}}\;d\mu\,\,.
\end{equation*}
\end{mteo}
%\hspace{1pt}
{\footnotesize
