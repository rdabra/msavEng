...
\end{equation}
Since these equalities are valid for all $\vto{x}\in U_\cam{F}$, let $B=\{\vun{u}_1,\cdots,\vun{u}_n\}$ be an arbitrary orthonormal basis of $U_\cam{F}$, from which it is valid to write that
