...
\end{equation}
according to \eqref{eq:genInnerProdVec} and \eqref{eq:defGradient2}. Now, considering equality \eqref{eq:secTens2Lin} and second order tensor $\tnr{G}_{\vto{x}_0}:=\fua{\nabla\tnr{\psi}}{\vto{x}_0^*}=\fua{\nabla\tnr{\hat{\psi}}}{\vto{x}_0}$, we also have for the present case that 
...
\end{equation*}
from which we easily verify the first equality of iv. By definition \eqref{eq:derivSameArg2}, proof of the second equality is straightforward. 
\end{proof}}
