...
[\fua{\partial_r\tnr{\varphi}}{\tnr{X}_1,\cdots,\tnr{X}_q}]{(\tnr{H}_r)}=\lim_{\alpha\to 0} \dfrac{\fua{\tnr{\varphi}}{\tnr{X}_1,\cdots,\tnr{X}_r+\alpha\tnr{H}_r,\cdots,\tnr{X}_q}-\fua{\tnr{\varphi}}{\tnr{X}_1,\cdots,\tnr{X}_q}}{\alpha}\,.
\end{equation}
From the above conditions, the property 
\begin{equation}
\fua{[\fua{\tnr{\varphi}'}{\tnr{X}_1,\cdots,\tnr{X}_q}]}{\tnr{H}_1,\cdots,\tnr{H}_q}=\sum_{i=1}^{q}[\fua{\partial_i\tnr{\varphi}}{\tnr{X}_1,\cdots,\tnr{X}_q}]{(\tnr{H}_i)}\,
\end{equation}
...
\sum_{i=1}^{q}[\fua{\partial_i\tnr{\varphi}}{\tnr{\varphi}_1(\tnr{Y}_1),\cdots,\tnr{\varphi}_q(\tnr{Y}_q)}\circ\tnr{\varphi}_i'(\tnr{Y}_i)]{(\tnr{H}_i)}\,,
\end{multline}
