...
Still considering previous conditions, the affinity in $\map{\mathit{h}}{\eamd{U}{F}{m}}{\eamd{U}{F}{m}}$ is called a \textsb{dilation}\index{dilation} and $\tnr{\mathit{h}}:= \upsilon_o\circ\mathit{h}\circ\upsilon_o^{-1}$ a \textsb{vector dilation}\index{vector!dilation} if bijection $\vtf{h}\in\evl{\cam{F}}{U}{U}$ in equality
