...
\begin{equation}
\fua{\mathit{f}}{\vto{u}\oplus a}=\fua{\tnr{\Upsilon}_{\tnr{A}}}{\vto{u}}\oplus\fua{\mathit{g}}{a}=(\vto{u}\cdot\vto{a}_1)\vto{a}_2\oplus\fua{\mathit{g}}{a}\,,\,\,\forall\,a\in\eamd{U}{F}{m}\,,\,\vto{v}\in U_\cam{F}\,,
\end{equation}
...
\fua{\mathit{h}}{\vto{u}\oplus a}=\fua{\vtf{h}}{\vto{u}}\oplus\fua{\mathit{g}}{a}\,,\,\,\forall\,a\in\eamd{U}{F}{m}\,,\,\vto{u}\in U_\cam{F}\,,
\end{equation}
...
\begin{equation*}
\fua{\mathit{h}_1\circ\mathit{h}_2}{\vto{u}\oplus a}=\fua{\mathit{h}_1}{\fua{\vtf{h}_2}{\vto{u}}\oplus\fua{\mathit{g}_2}{a}}=\fua{\vtf{h}_1\circ\vtf{h}_2}{\vto{u}}\oplus\fua{\mathit{g}_1\circ\mathit{g}_2}{a}
\end{equation*}
prove that $\mathit{h}_1\circ\mathit{h}_2$ is also a dilation and that $\fua{\mathit{h}^{-1}_1}{\vto{u}\oplus a}=\fua{\vtf{h}^{-1}_1}{\vto{u}}\oplus\fua{\mathit{g}^{-1}_1}{a}$. Considering the identity dilation $\mathit{i}$, similarly to the case of translations, it is straightforward to verify that dilations also obey the axioms of associativity, identity element, inverse element and commutativity on the operation of composition. Therefore, the set $H$ of all dilations on $\eamd{U}{F}{m}$ defines the abelian group $(H,\circ)$.
