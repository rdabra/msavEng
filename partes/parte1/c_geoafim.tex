...
\end{equation}
Note that, \emph{in the conext of a certain coordinate system, this ``vectorization'' function enables to identify a point by a vector and vice-versa}. Now, considering arbitrary $\vto{u},\vto{v}\in S_\cam{F}$, $a\in\eamsd{S}{F}{a}{n}$ and $\alpha\in\cam{F}$, the following properties are valid:
\begin{itemize}
	\setlength\itemsep{.1em}
