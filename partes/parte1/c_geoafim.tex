...
Considering an Euclidean affine oriented space $(U_\real,\tnr{A}_B)$ where $\dim(U_\real)\leqslant 3$, the \textsb{simple bivector} $\vv{ox}\times\vv{oy}$ defined by vectors $\vv{ox},\vv{oy}\in U_\real$ is here understood as the mathematical object used to express rotational physical quantities such as angular momentum and torque. In geometrical terms, the magnitude of a simple vector is defined to be the area of the parallelogram whose sides are $\|\vv{ox}\|$ and $\|\vv{oy}\|$  
