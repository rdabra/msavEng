 ...
 ***************** FALAR DE ORTOGONALIDADE DE RETAS
...
%INSERIR FIGURA DE ROTACAO E REFLEXÃO   
%colocar a base B no meio, uma seta representando a rotação para a direita e uma seta representando a reflexão para a esquerda (colocar a base original pontilhada em cada uma)
...
%
% DADO UM PONTO B, O CONJUNTO DAS AFINIDADES ISOMETRICAS CENTRADAS NO PONTO A constitui UMA HIPERESFERA COM CENTRO EM A E RAIO |AB|.
% DESENHAR ESSA HIPERESFERA.
% DISCORRER SOBRE QUAL O EFEITO GEOMÉRICO QUE O DETERMINANTE POSITIVO OU NEGATIVO PRODUZ PARA DIFERENCIAR GEOMETRICAMENTE ROTACAO E REFLEXAO.
% PARA ISSO, COMEÇAR PELA P. 87 ONDE UMA BASE CONTINUA BASE QUANDO SOBRE ELA ATUA UM OPERADOR ORTOGONAL, MANTENDO A MESMA ORIENTAÇÃO SE O OPERAOR FOR ORTOG. PROPRIO
% TAVLVEZ A COISA SAIA CONSIDERANDO VETORES E FUNCOES VETORIAS NA PAGINA 87 PORQUE AÍ EU TENHO O EFEITO DE DET POSITIVO OU NEGATIVO SOBRE UM DADO VETOR
