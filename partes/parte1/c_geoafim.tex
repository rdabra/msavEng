...
In the context of an affine Euclidean space $\eamd{S}{R}{n}$ where $\hat{\vv{ox}},\hat{\vv{oy}}\in S_\cam{R}$ are arbitrary unitary vectors, it is valid that $-1\leq\hat{\vv{ox}}\cdot\hat{\vv{oy}}\leq+1$.
\end{mcoro}
...
For the case of affine Euclidean spaces, projection $\fua{\zeta}{\vv{ox},\vv{oy}}$ is always a real number, that is, $\fua{\zeta}{\vv{ox},\vv{oy}}=|\fua{\zeta}{\vv{ox},\vv{oy}}|$,  and then a corollary of the previous theorem is the following inequality:
\begin{equation}
-1\leq\dfrac{\fua{\zeta}{,\vv{oy}}}{\|\vv{ox}\|}\leq+1\,,\,\forall\, x,y\in\{\eamd{S}{R}{n}\setminus o\}\,,
\end{equation}  
where the definition \ref{eq:projection} of projection is considered and 
