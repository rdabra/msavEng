...
If the group-field interaction assigns to the group certain multiplicative features, a group that is structured by metrics acquires the concept of distance. In other words, in a group-metrics space or a \textsb{metric space}\index{space!metric}, there is always a distance between two elements, measured in scalar values. This idea of distance is fundamental in Mathematics, making, for example, the usual notion of derivative viable and consequently of the elementary Differential Calculus as a whole. 


Like structuring by field, the structure of metrics in a group is also subjected to restrictions, described hereafter. Le 
