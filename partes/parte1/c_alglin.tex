...
\end{equation}
 where $\vtf{g}$ is called a \textsb{nonnegative linear operator}\footnote{Or positive-semidefinite positive-semidefinite\index{linear operator!psotive-semi-definite}.}\index{linear operator!nonnegative} or a \textsb{positive-definite linear operator}\index{linear operator!positive-definite} if the real value  $\Re(\vto{y}\cdot\fua{\vtf{g}}{\vto{y}})$ is always positive.
