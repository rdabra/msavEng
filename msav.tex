...
\makeoddfoot{myheadings}{\footnotesize\textsc{Mathematical Elements of Continuum Mechanics}}{}{\small{\thepage}}
...
\title{Entendendo a Teoria Matemática da Mecânica dos Sólidos Deformáveis}
\date{Versão 1.1.1 - Outubro de 2006}
...
%\chapter*{Lista de Proposições}
%\listtheorems{prp}

%linha de teste de retorno de versão
...
%    \include{partes/parte1/c_oqueAlgebra}
...
%    \include{partes/parte1/c_diftens}
%   \include{partes/parte1/c_medida}
    \include{partes/parte1/bibCh1}
%    \include{partes/parte2/parte2}
%    \include{partes/parte2/c_meccont}
%    \include{partes/parte2/c_cinemat}
